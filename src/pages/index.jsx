        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-6 max-w-5xl mx-auto pt-24">
                ...
                >
                    THE BROKER WHO
                    <br />
                    <span className="text-transparent" style={{ WebkitTextStroke: '1px rgba(212,175,55,0.7)' }}>
                        EDUCATES
                    </span>
                    <br />
                    CLOSES.
...
const featureTabs = [
    {
        ...
        points: [
            'Live charter demand signals by region',
            'Pre-owned market valuations updated regularly',
            'Route activity with broker context on each signal',
            'Free: 24hr delayed. Pro: real-time.',
        ],
        visual: 'intel',
    },
    {
        ...
        points: [
            'Full technical specs — descriptions never truncated',
            'Broker Insight: how to position each aircraft (Pro)',
            '3D cockpit view per aircraft (Pro)',
            'Compare up to 3 jets side by side (Pro)',
        ],
        visual: 'fleet',
    },
    {
        ...
        points: [
            ...
            'Route demand context with broker annotations',
            'Aircraft type filter by category',
            'Free: previous day. Pro: live real-time.',
        ],
        visual: 'track',
    },
    {
        ...
        points: [
            'Cost calculator with manual input fields — no sliders',
            'Client framing block — how to present the number (Pro)',
            'Route optimisation — best aircraft for the budget (Pro)',
            'No artificial limits on calculations',
        ],
        visual: 'plan',
    },
    {
        ...
        points: [
            'Aircraft performance and route qualification',
            'Sales positioning and objection handling',
            'Deal structure and negotiation guidance',
            'Available instantly — no waiting, no appointments',
        ],
        visual: 'chatbot',
    },
]
                    ...
                    <div className="flex flex-wrap gap-2">
                        {featureTabs.map((t) => (
                            <button
                                ...
                                className={`flex items-center gap-2.5 px-4 py-2.5 rounded-xl font-mono text-xs tracking-wider transition-all duration-200 border ${active === t.id
                            ...
                            >
                                {t.label}
                                <span
                                    className={`text-xs px-1.5 py-0.5 rounded font-bold ${t.badge === 'Free'
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <div className="p-8 rounded-2xl border border-[#1c1c1c]" style={{ background: 'rgba(14,14,14,0.8)' }}>
                            <p className="font-mono text-xs text-gold tracking-widest mb-4">
                        ...
                        >
                            ...
                            {tab.visual === 'fleet' && (
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-3 mt-2">
                                        {[
                                            { label: 'Range', value: '7,500nm' },
                                            { label: 'Speed', value: '516 kts' },
                                            { label: 'Category', value: 'Ultra Long Range' },
                                            { label: 'Passengers', value: '13-18' },
                                        ].map((d, i) => (
                                    ...
                                    {[
                                        ...
                                        <div key={i} className="p-3 rounded-xl border border-[#1c1c1c] bg-[#0d0d0d]">
                                            <div className="flex items-center justify-between mb-1.5">
                                                ...
                                                <span className={`font-mono text-xs px-2 py-0.5 rounded border ${f.status === 'En Route' ? 'text-green-400 border-green-400/20 bg-green-400/10' : 'text-gold border-gold/20 bg-gold/10'}`}>
                                                    {f.status}
                                                </span>
                                            </div>
                                            ...
                                            {f.progress > 0 && (
                                                <div className="h-1 bg-[#1c1c1c] rounded-full">
                                                    <div className="h-1 bg-gold rounded-full" style={{ width: `${f.progress}%` }} />
                                                </div>
                                            )}
                                        </div>
                                    ))}
                            ...
                            {tab.visual === 'plan' && (
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        {[
                                            { label: 'Origin', value: 'VABB — Mumbai' },
                                            { label: 'Destination', value: 'EGLL — London' },
                                            { label: 'Passengers', value: '8 pax' },
                                            { label: 'Aircraft', value: 'Ultra Long Range' },
                                        ].map((d, i) => (
                                            <div key={i} className="p-3 rounded-lg border border-[#1c1c1c] bg-[#0d0d0d]">
                                                <p className="font-mono text-xs text-gray-600">{d.label}</p>
                            ...
                            {tab.visual === 'chatbot' && (
                                <div className="space-y-3">
                                    ...
                                    <div className="flex justify-end">
                                        <div className="bg-gulf/20 border border-gulf/30 rounded-xl rounded-br-sm px-4 py-3 max-w-xs">
                                            <p className="font-body text-sm text-white">How do I handle a client who says it's too expensive?</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-2.5 px-4 py-3 border border-[#1c1c1c] rounded-xl bg-[#0d0d0d]">
                                        <motion.span
                                            ...
                                            style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#D4AF37', display: 'inline-block', flexShrink: 0 }}
                                        />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <Reveal>
                        ...
                        <h2 className="font-display text-4xl md:text-5xl text-white mb-4 leading-tight">
                            A 20-year aviation<br />
                            <span className="text-gold">advisor. On demand.</span>
                        </h2>
                        <p className="font-body text-gray-400 text-sm leading-relaxed mb-6">
                            Pro subscribers get the Altus Aero AI Advisor — powered by Claude AI. Ask it anything relevant to a working jet broker: aircraft specs, route qualification, how to handle price objections, deal structure, negotiation angles. It answers in seconds with the depth of an industry veteran.
                        </p>
                        <ul className="space-y-2.5 mb-8">
                            {[
                                'Aircraft performance, range, and route qualification',
                                'Sales positioning and objection handling — specific to aviation',
                                'Deal structure guidance and negotiation tactics',
                        ...
                        <Link
                            to="/login"
                            className="inline-block font-display text-sm text-jet px-8 py-3.5 rounded-xl tracking-widest font-bold hover:opacity-90 transition-opacity"
                            style={{ background: '#D4AF37' }}
                        >
                            GET PRO ACCESS
                        </Link>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-start">
                                    <div className="border border-[#1c1c1c] rounded-xl rounded-bl-sm px-4 py-3" style={{ maxWidth: '90%', background: 'rgba(255,255,255,0.03)' }}>
                                        <p className="font-mono text-xs text-gold mb-1.5">ADVISOR</p>
                                        <p className="font-body text-sm text-gray-200 leading-relaxed">G650ER at 4,387nm qualifies nonstop with reserves. Charter rate ~$14,000/hr. It is the standard recommendation on this route — operators know it, clients trust it. If budget allows, show the G700 side by side — the cabin upgrade justifies itself on a 9-hour flight.</p>
                                    </div>
                                </div>
                                <div className="flex justify-end">
                                    <div className="bg-gulf/20 border border-gulf/30 rounded-xl rounded-br-sm px-4 py-3" style={{ maxWidth: '85%' }}>
    ...
    const steps = [
        {
            ...
            body: 'Start with Fleet. Every aircraft — full specs, range, cabin dimensions, and Broker Insights on how to position each one. Know the G650ER from the Global 7500 before your first client call.',
        },
        {
            num: '02',
            title: 'Know the market',
            body: 'Intel surfaces live market signals with broker context on every data point. Track which routes are active, where demand is building, and what the pre-owned market is doing — before your competition does.',
        },
        {
            num: '03',
            title: 'Close with confidence',
            body: 'Plan any route. Calculate charter costs. Frame the number for the client. Use the AI advisor to handle objections. Walk into every meeting knowing the aircraft, the market, and the deal.',
        },
    ]
                        ...
                        <div className="p-8 rounded-2xl border border-[#1c1c1c] h-full flex flex-col" style={{ background: '#0d0d0d' }}>
                            <div>
                                ...
                                <p className="font-display text-5xl text-white mb-8">
                                    ₹0<span className="text-base text-gray-500 font-body"> / forever</span>
                                </p>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="font-display text-5xl text-white mb-1">
                                    ₹{annual ? '1,999' : '2,499'}<span className="text-base text-gray-500 font-body"> /mo</span>
                                </p>
                                {annual && (
            ...
            <div className="max-w-6xl mx-auto">
                            ...
                            <ul className="space-y-2.5">
                                {col.links.map((l) => (
                                    <li key={l.title}>
                                        <a
                                            href={l.href}
                                            className="font-body text-sm text-gray-600 hover:text-gray-300 transition-colors"
                                        >
                                            {l.title}
                                        </a>
                                    </li>
                ...
                <div className="pt-8 border-t border-[#1c1c1c] flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="font-mono text-xs text-gray-700">
                        © 2026 Altus Aero. All rights reserved.
                    </p>
                    <p className="font-mono text-xs text-gray-700">
                        Built for aspiring jet brokers worldwide.
                    </p>
                </div>
            </div>
        </footer>
