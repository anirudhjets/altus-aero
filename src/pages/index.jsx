    ...
    return (
        ...
        >
            <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 48px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                >
                    <span style={{ display: 'block', height: '1px', width: '22px', background: open ? '#D4AF37' : '#999999', transition: 'all 0.3s', transform: open ? 'rotate(45deg) translate(4px, 4px)' : 'none' }} />
        ...
        <section style={{ position: 'relative', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', background: '#0a0a0a' }}>
            ...
            <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', padding: '0 24px', maxWidth: '1100px', margin: '0 auto', paddingTop: '96px' }}>
                ...
                <motion.p
                    ...
                    style={{ ...EYEBROW, color: '#D4AF37', marginBottom: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px' }}
                >
                    <span style={{ display: 'inline-block', width: '32px', height: '1px', background: '#D4AF37', opacity: 0.5 }} />
                ...
                >
                    THE BROKER
                    <br />
                    <span style={{ color: 'transparent', WebkitTextStroke: '1px rgba(212,175,55,0.6)' }}>WHO EDUCATES</span>
                    <br />
                    CLOSES.
                </motion.h1>
                ...
                >
                    {[
                        ...
                        <div key={i} style={{ textAlign: 'center' }}>
                            <p style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '36px', color: '#D4AF37', lineHeight: 1 }}>{s.value}</p>
        ...
        <section style={{ borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)', background: '#0a0a0a', padding: '96px 24px' }}>
            <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
                <Reveal>
                    ...
                    <div style={{ width: '1px', height: '48px', background: 'rgba(212,175,55,0.3)', margin: '48px auto 0' }} />
                </Reveal>
            </div>
        </section>
    )
            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                <Reveal>
                    ...
                    <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: 'clamp(40px, 6vw, 80px)', color: '#ffffff', lineHeight: 1.0, letterSpacing: '0.02em', marginBottom: '16px' }}>
                        ...
                        <span style={{ color: '#D4AF37' }}>TAKE THE TIME TO LEARN.</span>
                    </h2>
                        ...
                        {featureTabs.map((t) => (
                            <button
                                ...
                                style={{
                                    ...
                                    padding: '10px 20px',
                                    borderRadius: '9999px',
                                    border: active === t.id ? '1px solid #D4AF37' : '1px solid rgba(255,255,255,0.12)',
                                    background: active === t.id ? 'rgba(212,175,55,0.08)' : 'transparent',
                                    color: active === t.id ? '#D4AF37' : '#999999',
                                    cursor: 'pointer',
                                    transition: 'all 0.2s',
                                    display: 'flex',
                                    alignItems: 'center',
                            ...
                            >
                                ...
                                <span style={{
                                    ...
                                    padding: '2px 7px',
                                    borderRadius: '9999px',
                                    background: t.badge === 'Free' ? 'rgba(74,222,128,0.1)' : 'rgba(212,175,55,0.1)',
                                    color: t.badge === 'Free' ? '#4ade80' : '#D4AF37',
                                    border: t.badge === 'Free' ? '1px solid rgba(74,222,128,0.2)' : '1px solid rgba(212,175,55,0.2)',
                                }}>
                                    {t.badge}
                                </span>
                            </button>
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        <div style={{ background: '#0a0a0a', padding: '48px' }}>
                            <p style={{ ...EYEBROW, color: tab.badge === 'Free' ? '#4ade80' : '#D4AF37', marginBottom: '20px' }}>
                            ...
                            <ul style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                {tab.points.map((p, i) => (
                                    <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', fontFamily: 'DM Sans, sans-serif', fontSize: '13px', color: 'rgba(255,255,255,0.6)' }}>
                                        <span style={{ color: '#D4AF37', flexShrink: 0, marginTop: '1px' }}>—</span>{p}
                                    </li>
                                ))}
                            </ul>
                        </div>
                        ...
                        <div style={{ background: '#080808', padding: '48px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                    ...
                                    {[
                                        ...
                                        <div key={i} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px', border: '1px solid rgba(255,255,255,0.06)', background: '#0a0a0a' }}>
                                            ...
                                            <p style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '28px', color: d.positive ? '#4ade80' : '#D4AF37', lineHeight: 1 }}>{d.value}</p>
                                        </div>
                                    ))}
                                    <div style={{ padding: '16px 20px', border: '1px solid rgba(212,175,55,0.15)', background: 'rgba(212,175,55,0.03)', marginTop: '4px' }}>
                                        <p style={{ ...EYEBROW, color: '#D4AF37', fontSize: '10px', marginBottom: '8px' }}>Broker Context</p>
                            ...
                            {tab.visual === 'fleet' && (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                    ...
                                    <p style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '72px', color: '#D4AF37', lineHeight: 1.0 }}>G650ER</p>
                                    ...
                                    <div style={{ borderLeft: '1px solid #D4AF37', paddingLeft: '16px' }}>
                                        <p style={{ ...EYEBROW, color: '#D4AF37', fontSize: '10px', marginBottom: '8px' }}>Broker Insight — Pro</p>
                                    ...
                                    {[
                                        ...
                                        <div key={i} style={{ padding: '14px 16px', border: '1px solid rgba(255,255,255,0.06)', background: '#0a0a0a' }}>
                                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
                                                ...
                                                <span style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '9px', letterSpacing: '0.1em', textTransform: 'uppercase', padding: '3px 8px', border: f.status === 'En Route' ? '1px solid rgba(74,222,128,0.25)' : '1px solid rgba(212,175,55,0.25)', color: f.status === 'En Route' ? '#4ade80' : '#D4AF37', background: f.status === 'En Route' ? 'rgba(74,222,128,0.06)' : 'rgba(212,175,55,0.06)' }}>{f.status}</span>
                                            </div>
                                            <p style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '10px', color: '#444', marginBottom: f.progress > 0 ? '8px' : 0 }}>{f.aircraft}</p>
                                            {f.progress > 0 && <div style={{ height: '1px', background: 'rgba(255,255,255,0.06)' }}><div style={{ height: '1px', background: '#D4AF37', width: `${f.progress}%` }} /></div>}
                                        </div>
                                    ))}
                                </div>
                            )}
                            {tab.visual === 'plan' && (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                    ...
                                    <div style={{ padding: '20px', border: '1px solid rgba(212,175,55,0.2)', background: 'rgba(212,175,55,0.03)' }}>
                                        <p style={{ ...EYEBROW, color: '#D4AF37', fontSize: '10px', marginBottom: '8px' }}>Estimated Charter Cost</p>
                            ...
                            {tab.visual === 'chatbot' && (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                                        <div style={{ background: 'rgba(30,58,138,0.15)', border: '1px solid rgba(30,58,138,0.3)', padding: '12px 16px', maxWidth: '80%' }}>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
                                        <div style={{ background: '#0a0a0a', border: '1px solid rgba(255,255,255,0.06)', padding: '12px 16px', maxWidth: '85%' }}>
                                            <p style={{ ...EYEBROW, color: '#D4AF37', fontSize: '9px', marginBottom: '8px' }}>Advisor</p>
        ...
        <section style={{ padding: '120px 24px', background: '#080808', borderTop: '1px solid rgba(255,255,255,0.04)' }}>
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
                    <Reveal>
                        <span style={{ ...EYEBROW, background: '#D4AF37', color: '#0a0a0a', padding: '4px 12px', borderRadius: '9999px', display: 'inline-block', marginBottom: '32px' }}>PRO FEATURE</span>
                        <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: 'clamp(36px, 5vw, 72px)', color: '#ffffff', lineHeight: 1.0, letterSpacing: '0.02em', marginBottom: '24px' }}>
                            A 20-YEAR AVIATION<br /><span style={{ color: '#D4AF37' }}>ADVISOR. ON DEMAND.</span>
                        </h2>
                        <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '14px', color: '#999999', lineHeight: 1.75, marginBottom: '32px' }}>
                        ...
                        <ul style={{ display: 'flex', flexDirection: 'column', gap: '14px', marginBottom: '40px' }}>
                            {['Aircraft performance, range, and route qualification', 'Sales positioning and objection handling', 'Deal structure guidance and negotiation tactics', 'Available 24/7 — no waiting, no appointments'].map((p, i) => (
                                <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', fontFamily: 'DM Sans, sans-serif', fontSize: '13px', color: 'rgba(255,255,255,0.55)' }}>
                                    <span style={{ color: '#D4AF37', flexShrink: 0 }}>—</span>{p}
                                </li>
                            ))}
                        </ul>
                        <Link
                        ...
                        <div style={{ border: '1px solid rgba(255,255,255,0.06)', background: '#0a0a0a' }}>
                            <div style={{ padding: '20px 24px', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', gap: '14px' }}>
                                <div style={{ width: '36px', height: '36px', borderRadius: '50%', background: '#1e3a8a', border: '1px solid rgba(212,175,55,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                                    <span style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '11px', color: '#D4AF37' }}>AI</span>
                                </div>
                                <div>
                                    <p style={{ ...EYEBROW, color: '#D4AF37', fontSize: '10px' }}>ALTUS AI ADVISOR</p>
                            ...
                            <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                                    <div style={{ background: 'rgba(30,58,138,0.15)', border: '1px solid rgba(30,58,138,0.3)', padding: '12px 16px', maxWidth: '85%' }}>
                    ...
                    <div style={{ border: '1px solid rgba(255,255,255,0.06)', padding: '56px', position: 'relative', overflow: 'hidden', background: '#080808' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px', position: 'relative', zIndex: 1 }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                                <div style={{ width: '56px', height: '56px', borderRadius: '50%', background: '#1e3a8a', border: '1px solid rgba(212,175,55,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                                    <span style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '18px', color: '#D4AF37' }}>AS</span>
                                </div>
                                <div>
                                    <p style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '18px', color: '#ffffff', letterSpacing: '0.05em', lineHeight: 1 }}>Anirudh Shinde</p>
                                    <p style={{ ...EYEBROW, color: '#D4AF37', fontSize: '10px', marginTop: '5px' }}>Founder · Mumbai, India</p>
                                </div>
                            </div>
            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                <Reveal>
                    ...
                    <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: 'clamp(40px, 6vw, 80px)', color: '#ffffff', lineHeight: 1.0, letterSpacing: '0.02em' }}>
                        THREE STEPS TO BECOMING<br /><span style={{ color: '#D4AF37' }}>THE BROKER CLIENTS TRUST.</span>
                    </h2>
                </Reveal>
            ...
            <div style={{ maxWidth: '960px', margin: '0 auto' }}>
                <Reveal style={{ textAlign: 'center', marginBottom: '64px' }}>
                    ...
                    <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: 'clamp(40px, 6vw, 80px)', color: '#ffffff', lineHeight: 1.0, letterSpacing: '0.02em', marginBottom: '24px' }}>
                        LEARN FOR FREE.<br /><span style={{ color: '#D4AF37' }}>CLOSE WITH PRO.</span>
                    </h2>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1px', background: 'rgba(255,255,255,0.06)' }}>
                    ...
                    <Reveal delay={0.1}>
                        <div style={{ padding: '48px', background: '#080808', display: 'flex', flexDirection: 'column', height: '100%', boxSizing: 'border-box', borderLeft: '1px solid rgba(212,175,55,0.15)' }}>
                            <div style={{ flex: 1 }}>
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '6px' }}>
                                    <p style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '28px', color: '#ffffff', letterSpacing: '0.05em' }}>Pro</p>
                                    <span style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '9px', letterSpacing: '0.12em', color: '#0a0a0a', background: '#D4AF37', padding: '4px 10px', borderRadius: '9999px' }}>RECOMMENDED</span>
                                </div>
                                <p style={{ ...EYEBROW, color: '#D4AF37', fontSize: '10px', marginBottom: '32px' }}>Full platform + AI advisor</p>
...
function CTABanner() {
    return (
        <section style={{ padding: '120px 24px', background: '#080808', borderTop: '1px solid rgba(255,255,255,0.04)' }}>
            <Reveal>
                <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center', padding: '96px 48px', border: '1px solid rgba(212,175,55,0.15)', background: '#0a0a0a', position: 'relative', overflow: 'hidden' }}>
                    <div style={{ position: 'absolute', top: 0, left: '50%', transform: 'translateX(-50%)', width: '40%', height: '1px', background: 'linear-gradient(to right, transparent, rgba(212,175,55,0.5), transparent)' }} />
                    <div style={{ position: 'absolute', bottom: 0, left: '50%', transform: 'translateX(-50%)', width: '40%', height: '1px', background: 'linear-gradient(to right, transparent, rgba(212,175,55,0.25), transparent)' }} />
                    <p style={{ ...EYEBROW, marginBottom: '24px' }}>Get Started Today</p>
                    <h2 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: 'clamp(40px, 6vw, 80px)', color: '#ffffff', lineHeight: 1.0, letterSpacing: '0.02em', marginBottom: '24px' }}>
                        JOIN BROKERS WHO LEARN<br /><span style={{ color: '#D4AF37' }}>BEFORE THEY SELL.</span>
                    </h2>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '48px', marginBottom: '64px' }}>
                    <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
                            <span style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '20px', color: '#D4AF37', letterSpacing: '0.25em' }}>ALTUS</span>
                            <span style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '9px', background: '#D4AF37', color: '#0a0a0a', padding: '3px 7px', letterSpacing: '0.15em', borderRadius: '2px' }}>AERO</span>
                        </div>
