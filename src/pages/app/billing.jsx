        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', maxWidth: '760px', margin: '0 auto' }}>
            ...
            <div style={{ border: '1px solid rgba(255,255,255,0.06)', background: '#0a0a0a' }}>
                ...
                <div style={{ padding: '24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
                    <div>
                        <p style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '52px', lineHeight: 1.0, color: isPro ? '#0ABFBC' : '#333' }}>{isPro ? 'PRO' : 'FREE'}</p>
                        ...
                        {isProPreview && plan !== 'pro' && (
                            <p style={{ ...MONO, fontSize: '9px', color: 'rgba(10,191,188,0.4)', marginTop: '6px', letterSpacing: '0.06em' }}>Viewing as Pro · Preview mode active</p>
                        )}
                    </div>
                    <span style={{
                ...
                <div style={{ display: 'grid', gap: '1px', background: 'rgba(255,255,255,0.04)' }} className="grid grid-cols-2 sm:grid-cols-4">
                    {[
                        ...
                        <div key={i} style={{ padding: '20px', background: '#0a0a0a' }}>
                            ...
                            <p style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '36px', color: u.highlight ? '#f87171' : '#0ABFBC', lineHeight: 1 }}>{u.value}</p>
                ...
                <div id="upgrade-section" style={{ border: '1px solid rgba(255,255,255,0.06)', background: '#0a0a0a' }}>
                    ...
                    <div style={{ padding: '24px' }}>
                        ...
                        <div style={{ display: 'grid', gap: '1px', background: 'rgba(255,255,255,0.05)' }} className="grid grid-cols-1 sm:grid-cols-2">
                                ...
                                <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 24px', display: 'flex', flexDirection: 'column', gap: '10px', flex: 1 }}>
                                    {FREE_FEATURES.map((f, i) => (
                                        <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                                            <span style={{ color: '#0ABFBC', flexShrink: 0 }}>—</span>
                            ...
                            {/* Pro */}
                            <div style={{ padding: '32px', background: '#080808', display: 'flex', flexDirection: 'column', borderLeft: '1px solid rgba(10,191,188,0.15)', position: 'relative', overflow: 'hidden' }}>
                                <div style={{ position: 'absolute', top: 0, left: '50%', transform: 'translateX(-50%)', width: '50%', height: '1px', background: 'linear-gradient(to right, transparent, rgba(10,191,188,0.5), transparent)' }} />
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '6px' }}>
                                    <p style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '22px', color: '#ffffff', letterSpacing: '0.05em' }}>Pro</p>
                                    <span style={{ ...MONO, fontSize: '9px', letterSpacing: '0.12em', color: '#0a0a0a', background: '#0ABFBC', padding: '3px 10px', borderRadius: '9999px' }}>RECOMMENDED</span>
                                </div>
                                ...
                                <button
                                    ...
                                    style={{ ...MONO, fontSize: '11px', letterSpacing: '0.15em', padding: '14px', background: '#0ABFBC', color: '#0a0a0a', border: 'none', borderRadius: '9999px', cursor: 'pointer', transition: 'opacity 0.2s' }}
