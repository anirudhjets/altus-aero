                        ...
                        <div key={signal.id} style={{ background: '#0a0a0a', overflow: 'hidden' }}>
                            ...
                            {isExpanded && (
                                <div style={{ padding: '0 24px 24px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                                    ...
                                    {isPro ? (
                                        <div style={{ padding: '20px', border: '1px solid rgba(10,191,188,0.15)', background: 'rgba(10,191,188,0.02)' }}>
                                            <p style={{ ...EYEBROW, color: '#0ABFBC', marginBottom: '12px' }}>Broker Context</p>
