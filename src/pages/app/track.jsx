...
const STATUS = {
    ...
    'Scheduled': { color: '#D4AF37', bg: 'rgba(212,175,55,0.06)', border: 'rgba(212,175,55,0.2)' },
    ...
    return (
        <div style={{ position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'rgba(8,8,8,0.88)', backdropFilter: 'blur(2px)', gap: '10px', padding: '16px' }}>
                ...
                <button onClick={() => navigate('/app/billing')} style={{ ...MONO, fontSize: '10px', letterSpacing: '0.15em', padding: '8px 20px', background: '#D4AF37', color: '#0a0a0a', border: 'none', borderRadius: '9999px', cursor: 'pointer' }}>
                    UPGRADE TO PRO
                </button>
            </div>
        </div>
...
function FlightMap({ flights, isPro }) {
    return (
        <div style={{
            ...
            border: '1px solid rgba(30,58,138,0.2)', position: 'relative', overflow: 'hidden',
        }}>
            <div style={{ position: 'absolute', inset: 0, opacity: 0.1, backgroundImage: 'linear-gradient(rgba(30,58,138,0.6) 1px, transparent 1px), linear-gradient(90deg, rgba(30,58,138,0.6) 1px, transparent 1px)', backgroundSize: '48px 48px' }} />
            ...
            {!isPro && (
                <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'rgba(8,8,8,0.7)', backdropFilter: 'blur(4px)', gap: '8px' }}>
                    <p style={{ ...MONO, fontSize: '9px', color: '#D4AF37', letterSpacing: '0.2em' }}>PRO FEATURE</p>
                ...
                {categories.map(c => (
                    <button
                        ...
                        style={{
                            ...
                            background: filter === c ? 'rgba(212,175,55,0.06)' : 'transparent',
                            borderColor: filter === c ? 'rgba(212,175,55,0.3)' : 'rgba(255,255,255,0.08)',
                            color: filter === c ? '#D4AF37' : '#444',
                        }}
                    >
                        {c.toUpperCase()}
                    </button>
                            ...
                            >
                                ...
                                {selected?.id === f.id && (
                                    <div style={{ marginTop: '16px', paddingTop: '16px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                                        ...
                                        {isPro && (
                                            <div style={{ marginTop: '1px', padding: '16px 18px', border: '1px solid rgba(212,175,55,0.12)', background: 'rgba(212,175,55,0.02)' }}>
                                                <p style={{ ...EYEBROW, color: '#D4AF37', marginBottom: '8px' }}>Route Context</p>
